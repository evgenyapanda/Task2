    ...
    <div id="top">
        <div class="container">
            ...
            <div class="enter right">
                ...
                <a class="poplight" rel="popup_contact" href="{{ url('/login') }}">Registration</a>               <span>/</span>
                <a class="poplight" rel="popup_contact" class="button poplight" href="{{ url('/register') }}">Login</a>
